/** Featured case studies — hero images under `public/Hitouch Pictures/` (cache-busted). */
...
/** Card/hero image from `public/images/featured-work/{slug}/01.jpg` (add file when gallery photos are ready). */
function featuredWorkSlotImage(slug) {
  return `/images/featured-work/${slug}/01.jpg?v=${PUBLIC_ASSET_VERSION}`
}
...
export const featuredProjects = [
  ...
  },
  {
    ...
    category: "Gala",
    title: "Black Brain Campaign's Annual Green Tie Gala",
    listDescription:
  ...
  {
    slug: "free-library-community-impact-week",
    category: "Community impact",
    title: "Free Library Foundation of Philadelphia — Annual Community Impact Week",
    listDescription:
      "HiTouch partnered with the Free Library Foundation of Philadelphia on Annual Community Impact Week—a week-long initiative advancing health equity, literacy, and community empowerment, with live activations, educational programming, and an awards reception honoring local health heroes.",
    image: featuredWorkSlotImage("free-library-community-impact-week"),
    body: [
      "HiTouch Enterprises proudly partnered with the Free Library Foundation of Philadelphia to support the Annual Community Impact Week, a dynamic week-long initiative focused on advancing health equity, literacy, and community empowerment throughout Philadelphia. Through a series of live activations, educational programming, and wellness-focused community engagement efforts hosted within the library, the event highlighted local heroes and organizations making meaningful contributions to health accessibility and awareness.",
      "The week concluded with an exclusive awards reception celebrating individuals and initiatives that have helped transform health outcomes across the city. HiTouch provided event production support, logistics coordination, activation management, guest experience oversight, and on-site execution to help deliver an impactful and community-centered experience.",
    ],
  },
  {
    slug: "frankford-cdc-fall-fest",
    category: "Community celebration",
    title: "Frankford CDC Fall Fest",
    listDescription:
      "HiTouch produced the Frankford CDC Fall Fest—a vibrant neighborhood celebration with local food vendors, interactive activities, community resources, and a Children’s Village with games, face painting, and family-friendly entertainment.",
    image: featuredHitouchFile("Frankford CDC Fall Festival.jpg"),
    body: [
      "HiTouch Enterprises proudly produced the Frankford CDC Fall Fest, a vibrant community celebration that brought together residents, families, local businesses, and community organizations for a day filled with fun, connection, and neighborhood pride. The event featured local food vendors, interactive activities, community resources, and a lively Children’s Village with games, face painting, and family-friendly entertainment designed to engage guests of all ages.",
      "HiTouch provided event production, logistics coordination, vendor management, community engagement support, and on-site execution to help create a welcoming and memorable experience that celebrated the spirit and culture of the Frankford community.",
    ],
  },
]
