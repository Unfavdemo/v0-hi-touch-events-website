...
export const featuredProjects = [
  ...
  {
    slug: "free-library-community-impact-week-2025",
    category: "Community impact",
    title: "Free Library Foundation of Philadelphia — 2025 Community Impact Awards Week",
    listDescription:
      "HiTouch partnered to produce the 2025 Community Impact Awards Week—a week-long initiative advancing health equity, literacy, and community wellness at the Free Library's atrium, with live activations, educational programming, and an awards reception honoring local heroes.",
    image: featuredHitouchFile("Commmunity impact week awards.jpg"),
    body: [
      "HiTouch Enterprises proudly partnered to produce the 2025 Community Impact Awards Week, a powerful initiative focused on advancing health equity, literacy, and community wellness throughout Philadelphia. Hosted within the Free Library's atrium, the week-long series of activations highlighted local heroes, organizations, and programs making a meaningful impact through health education, accessibility, and wellness resources. Community members engaged in live demonstrations, educational programming, and resource distribution efforts ranging from cooking classes to health classes.",
      "The initiative concluded with an exclusive awards reception honoring individuals and organizations whose work has helped transform health outcomes across the city. HiTouch provided event production, logistics coordination, activation management, guest experience support, and on-site execution to help deliver an impactful and community-centered experience.",
    ],
  },
  {
