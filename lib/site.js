...
/**
 * Elfsight Instagram Feed widget UUID (from install code class `elfsight-app-<uuid>`).
 * Override with NEXT_PUBLIC_ELFSIGHT_INSTAGRAM_FEED_CLASS: either the raw UUID or full `elfsight-app-…` class.
 */
const rawElfsightFeedId =
  process.env.NEXT_PUBLIC_ELFSIGHT_INSTAGRAM_FEED_CLASS?.trim() ||
  "f6dcacd9-0108-4477-b7c0-c51c6fe24787"
export const socialFeedElfsightWidgetId = rawElfsightFeedId.replace(/^elfsight-app-/, "")
...
export const teamMembers = [
  {
    ...
    image: "/images/team/Felicia D. Williams_Founder and CEO.webp",
