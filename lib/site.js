...
function featuredHitouchFile(filename) {
  return `/${["Hitouch Pictures", filename].map(encodeURIComponent).join("/")}`
}
...
export const featuredProjects = [
  ...
  {
    slug: "odaat-a-season-of-gratitude",
    category: "Community impact",
    title: "ODAAT A Season of Gratitude",
    listDescription:
      "Season of Gratitude—Thanksgiving food giveaways and Christmas outreach with meals, toys, clothing, and essentials for Philadelphia families. HiTouch coordinates logistics, community engagement, and on-site operations.",
    image: `${featuredHitouchFile("ODAAT A Season of Grattitude chrismas.jpg")}?v=20260513`,
    body: [
      "HiTouch Enterprises proudly partnered with One Day at a Time (ODAAT) Philadelphia to support the Season of Gratitude initiative, a holiday outreach program dedicated to uplifting families throughout Philadelphia during Thanksgiving and Christmas. Through the Annual Thanksgiving Food Giveaway and holiday celebration efforts, ODAAT provided meals, toys, winter clothing, household essentials, and festive experiences to families facing hardship, ensuring they felt supported, valued, and cared for during the holiday season.",
  ...
  {
    slug: "frankford-cdc-holiday-festival-2025",
    category: "Community festival",
    title: "Frankford CDC — Holiday Festival & Winter Village",
    listDescription:
      "HiTouch partnered with Frankford CDC on the 2025 Frankford Holiday Festival & Winter Village at Pause Park—live entertainment, youth performances, seasonal food and drinks, local vendors, and interactive activities celebrating Frankford’s culture.",
    image: featuredHitouchFile("CDC Winter Festival.jpg"),
    body: [
      "HiTouch Enterprises proudly partnered with Frankford CDC to produce the 2025 Frankford Holiday Festival & Winter Village at Pause Park, creating a festive and family-friendly experience that brought holiday cheer and community connection to the Frankford neighborhood. The event featured live entertainment, youth performances, seasonal food and drinks, local vendors, and interactive activities that celebrated the culture and spirit of the community.",
      "HiTouch provided comprehensive event production services, including logistics management, vendor coordination, marketing support, fundraising assistance, and on-site execution, helping transform the space into a vibrant holiday destination for residents and visitors alike.",
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Welcome America — The Grove (Mayor’s VIP)",
    listDescription:
      "HiTouch supported production of The Grove Experience at Eakins Oval—an elevated Mayor’s VIP evening with curated décor, luxury lounges, specialty food and beverage, live performances, awards, and branded moments alongside NBC10 Philadelphia coverage.",
    ...
    body: [
      ...
      "HiTouch provided event production support, inventory and logistics management, vendor coordination, décor oversight, and on-site execution to help create a polished and memorable experience alongside production partners and media coverage from NBC10 Philadelphia.",
    ],
  },
  {
 ...
 * (e.g. `tori-henry.jpg`). Still missing: Kayla Frazer, Cherrell Woodley, Kaylan Julien.
 */
