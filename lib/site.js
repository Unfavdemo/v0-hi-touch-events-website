...
export const featuredProjects = [
  ...
  },
  {
    ...
    title: "Community Heros Brunch",
    listDescription:
      "HiTouch partnered with Frankford CDC on the Community Heros Brunch—recognizing local champions over brunch, program remarks, and networking that celebrated neighbors and partners strengthening Frankford.",
    image: featuredHitouchFile("Community Heros Brunch.jpg"),
    body: [
      "HiTouch Enterprises proudly partnered with Frankford CDC to produce the Community Heros Brunch, bringing together neighbors, leaders, and partners to honor the people who show up for Frankford every day. The event combined a warm, welcoming brunch with a thoughtful program, recognition moments, and space to connect around community impact and shared pride in the neighborhood.",
      "HiTouch provided comprehensive event production services, including logistics management, vendor and venue coordination, program support, and on-site execution—helping the Frankford CDC team deliver a polished experience that put community voices and honorees at the center.",
    ],
  },
  {
